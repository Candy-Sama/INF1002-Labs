...
def myMain():
    for arg in sys.argv[1:]:
        strList = arg.split(',') #Does .split also remove spaces? Yes, it does remove spaces if there are any
        intList = [int(num) for num in strList] #convert each element in strList to integer and store in intList
